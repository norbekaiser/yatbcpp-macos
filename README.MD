...
* Hello-User Example [Github](https://github.com/norbekaiser/yatbcpp-hello-user) [yatbcpp.norbert-ruehl.de](https://yatbcpp.norbert-ruehl.de/src/?p=yatbcpp-example-hello-user;a=tree)
